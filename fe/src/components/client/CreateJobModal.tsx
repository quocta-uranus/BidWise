...
export default function CreateJobModal({ onClose, onSuccess }: Props) {
  ...
  const [currentStep, setCurrentStep] = useState(1); // 1: Basic info, 2: Budget, 3: AHP
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full h-10 px-3.5 rounded-xl border border-slate-200 text-sm font-medium outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 bg-white"
                      >
                        {categories.map((c) => (
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <input
                        ...
                        placeholder={skills.length === 0 ? (language === 'vi' ? 'React, Node.js, Figma...' : 'React, Node.js, Figma...') : ''}
                ...
                <>
                  ...
                  {budgetFormat === 'FIXED' ? (
                    ...
                    <div className="space-y-1.5">
                      ...
                      {(errors.budget || errors.maxBudget) && (
                        <p className="text-xs text-red-500 font-semibold">{errors.budget || errors.maxBudget}</p>
                      )}
                    </div>
                  )}
                        ...
                        <div key={criterion.key}>
                          <div className="flex justify-between items-center mb-1.5">
                            <label className="text-xs font-extrabold text-slate-700">
                              {criterion.label[language as 'vi' | 'en']}
                            </label>
                          ...
                          <div className="flex items-center gap-3">
                            <input
                              ...
                              className="flex-1 h-1.5 bg-slate-300 rounded-lg appearance-none cursor-pointer accent-blue-600"
                            />
